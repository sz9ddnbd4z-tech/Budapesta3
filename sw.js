const C='budapeszt-v13';
const SHELL=['./','./index.html','./app-v8.html?v=20260909a','./app-v5.html?v=20260908g','./fix-ios.js?v=20260909a','./manifest.webmanifest','./icon-180.png','./icon.svg'];
