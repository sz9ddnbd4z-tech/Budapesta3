const C='budapeszt-v12';
const SHELL=['./','./index.html','./app-v8.html?v=20260908j','./app-v5.html?v=20260908g','./fix-ios.js?v=20260908j','./manifest.webmanifest','./icon-180.png','./icon.svg'];
...
self.addEventListener('fetch',e=>{
 ...
 const u=new URL(e.request.url),local=u.origin===self.location.origin,html=u.pathname.endsWith('.html')||u.pathname.endsWith('/')||u.pathname.endsWith('sw.js')||u.pathname.endsWith('.js');
